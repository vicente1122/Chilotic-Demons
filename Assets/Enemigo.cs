...
public class Enemigo : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (((player.transform.position.x - transform.position.x) * (player.transform.position.x - transform.position.x)) < (Vista * Vista)) //si el jugador esta visible en eje x
        {
            if (((player.transform.position.y - transform.position.y) * (player.transform.position.y - transform.position.y)) < (Vista * Vista) / 2)  //si el jugador esta visible en eje y
            {
                presente = true;
            }
        }
